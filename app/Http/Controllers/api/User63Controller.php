...
class User63Controller extends Controller
{
    ...
    public function getUserDetail63(Request $request, $id)
    {
    ...
    public function putUserDetail63(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhoto63(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhotoKTP63(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPassword63(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserAgama63(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'id_agama' => 'required|exists:agama63,id',
        ]);
    ...
    public function deleteUser63($id)
    {
        ...
        if ($user->delete()) {
            return new FormatApi(false, 'User Berhasil Dihapus', null);
        }
    }
}
