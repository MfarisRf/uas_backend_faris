...
<head>
    ...
    <link rel="icon" href="{{ URL::to('assets/images/logo/') }}" type='image/x-icon'>
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <br>
                            <h1 class="card-title">Selamat Datang, {{ Auth::user()->role }} !</h1>
                        </div>
                                            ...
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td style="width: 125px">
                                                        <form
                                                            action="{{ $URL }}/user63/{{ $item['id'] }}/agama"
                                                            method="POST">
                                                            @csrf
                                                            <div class="row">
                                                    ...
                                                    <td>
                                                        @if ($item['is_active'] == 1)
                                                            <a class="btn btn-warning btn-block"
                                                                href="{{ $URL }}/user63/{{ $item['id'] }}/status">
                                                                Nonaktifkan
                                                            </a>
                                                        @else
                                                    ...
                                                    <td><a class="btn btn-success btn-block"
                                                            href="{{ $URL }}/user63/{{ $item['id'] }}">Detail</a>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-danger btn-block"
                                                            href="{{ $URL }}/user63/{{ $item['id'] }}/delete">Delete</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
